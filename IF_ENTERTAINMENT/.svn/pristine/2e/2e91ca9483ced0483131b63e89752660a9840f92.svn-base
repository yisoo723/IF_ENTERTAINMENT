  ...
  eventRender: function (event, element, view) {
    ...
    element.popover({
      ...
      content: $('<div />', {
        ...
        .append('<p class="custom-font"><strong>등록자:</strong> ' + event.username + '</p>')

        .append('<p class="custom-font"><strong>구분:</strong> ' + event.type + '</p>')
        .append('<p class="custom-font"><strong>시간:</strong> ' + getDisplayEventDate(event) + '</p>')
